...
To create the Plotly charts I created python scripts and used the exec node to execute the script to output the chart. For the Vega Lite chart I took one of the examples and made an output of the to Github.

Extra node used in this exampl are:
